...
print()
print("_TODO 6:")
print("(5 - 2) + 7 evaluates to :", (5 - 2) + 7)
print("(10 / 5) + 20 evaluates to :", (10/5) + 20)
...
print()
print("_TODO 10:")
# print(This will cause an error!) ##missing quotes
# print(3 + 'hello') ##strings and ints cant be added
# print This will cause an error! ##missing parentheses
...
print()
print("_TODO 15:")
print("I'm not a bug, that's right!" + ' What does "yarborough" mean?'+())
