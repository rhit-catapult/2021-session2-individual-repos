...
def main():
    ...
    view_controller.game.take_turn(1, 1)  # Fake that a click just happened in the middle
    print(view_controller.game)
    view_controller.game.take_turn(2, 1)  # Fake that a click just happened in the middle
    print(view_controller.game)
    view_controller.game.take_turn(0, 0)  # Fake that a click just happened in the middle
    print(view_controller.game)
    view_controller.game.take_turn(1, 2)  # Fake that a click just happened in the middle
    print(view_controller.game)
    view_controller.game.take_turn(2, 2)  # Fake that a click just happened in the middle
    print(view_controller.game)
