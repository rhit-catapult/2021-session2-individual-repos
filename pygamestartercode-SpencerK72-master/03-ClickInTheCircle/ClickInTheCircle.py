...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            # TODO 4:   function and save the result into a variable called distance_from_circle
            ...
            # TODO 6: If distance_from_circle is greater than the circle_radius, set the message_text to 'You missed!'
                if distance_from_center > circle_radius:
                    print("you missed")
