...
class Missile:
    ...
    def draw(self):
        # Draw a vertical, 4 pixels thick, 8 pix els long, red (or green) line on the screen,
        # where the line starts at the current position of this Missile.
        pygame.draw.line(self.screen, (135, 229, 255), (self.x, self.y), (self.x, self.y + 4), 2)
...
class Fighter:
    ...
    def fire(self):
        ...
        # Append that Missile to this Fighter's list o f Missile objects.
...
def main():
    ...
    while True:
        ...
        for event in pygame.event.get():
            ...
            # if event.type == pygame.KEYDOWN: # REMOVE THIS FOR LASER
            # pressed_keys = pygame.key.get_pressed()
