...
#  _
#     a. You can use the blue bars to go from one _done_ to the next
#        by clicking on the blue bars.  ** Try that now. **
#  _
#     b. When you have completed a _done_, you should change the word
#          _done_      (ignore the underscores on this line)
#        to
#          DONE
#        Try it now on line 18 above, and note that its blue bar on the
#        scrollbar-like thing to the right goes away soon thereafter.
#  _
#   If you change each _done_ to DONE like this, you can tell when you
#   have finished all the exercises in a module -- there will be no
#   blue bars left on the scrollbar-like thing to the right.
#  _
#   You have now completed _done_ #2, so change its _done_ on line 32 to DONE
#   (and likewise for all forthcoming dones in this course).
###############################################################################
...
#   whom you trust:
#      What number did your   print   display for this _done_?
...
#     right?  If so, click on each blue bar and change its _done_ to
