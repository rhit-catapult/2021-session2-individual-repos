...
def main():
    ...
    while True:
        ...
        if pressed_keys[pygame.K_UP]:
            ...
            eye_y_delta -= 8
        if pressed_keys[pygame.K_DOWN]:
            print("You are holding down the Down arrow key!")
            eye_y_delta += 8
        if pressed_keys[pygame.K_RIGHT]:
        ...
        pygame.draw.circle(screen, (0, 0, 0), (242 + eye_x_delta, 162 + eye_y_delta), 7)  # black pupil left

        pygame.draw.circle(screen, (225, 225, 225), (400, 160), 25)  # white eye
        pygame.draw.circle(screen, (0, 0, 0), (400, 160), 25, 3)  # black outline
        pygame.draw.circle(screen, (0, 0, 0), (398 + eye_x_delta, 162 + eye_y_delta), 7)  # black pupil right
