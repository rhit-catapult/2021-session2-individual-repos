...
class Raindrop:
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (50,0,255), (self.x, self.y), (self.x, self.y - 5), 3)
...
class Cloud:
    ...
    def rain(self):
        ...
        new_raindrop = Raindrop(self.screen, random.randrange(self.x,self.x + self.image.get_width()), self.y + self.image.get_height())
