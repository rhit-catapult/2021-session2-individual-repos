...
class Raindrop:
    def __init__(self, screen, x, y):
        ...
        self.screen = screen
        # assigning the local variable (screen) into something longer lasting (self.screen)
        self.x = x
        self.y = y
        self.speed = random.randrange(5, 15)

        # pass allows the compiler to ignore the function, since it has no code in it
    ...
    def draw(self):
        ...
        pygame.draw.line(self.screen, (0, 100, 100), (self.x, self.y), (self.x, self.y + 5), 2)
...
class Hero:
    def __init__(self, screen, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        self.x = x
        self.y = y
        self.image_w_umbrella = pygame.image.load(with_umbrella_filename)
    ...
    def draw(self):
        ...
        if current_time > self.last_hit_time + 1.0:
            ...
            self.screen.blit(self.image_w_umbrella, (self.x, self.y))
    ...
    def hit_by(self, raindrop):
        ...
        hero_hit_box = pygame.Rect(self.x, self.y, self.image_w_umbrella.get_width(), self.image_w_umbrella.get_height())
...
class Cloud:
    ...
    def rain(self):
        ...
        new_raindrop = Raindrop(self.screen, random.randrange(self.x, self.x + 300), random.randrange(self.y, self.y + 100))
...
def main():
    ...
    while True:
       ...
       #  test_drop.draw()
        ...
        # DONE 29: Remove the temporary test_drop code from this function and refactor it as follows:
