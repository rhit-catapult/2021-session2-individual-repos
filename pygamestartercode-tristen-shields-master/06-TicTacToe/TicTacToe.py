...
def main():
    ...
    # print(view_controller.game)
    # view_controller.game.take_turn(0, 0)  # Fake that a click just happened in the very middle
    # print(view_controller.game)
    # view_controller.game.take_turn(1, 2)
    # print(view_controller.game)
    # view_controller.game.take_turn(2, 2)  # Fake that a click just happened in the very middle
    # print(view_controller.game)
